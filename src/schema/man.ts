...
export const createManSchema = z.object({
  ...
  hours_per_day: z.number({ required_error: "Kunlik ish soatini kiriting!" }).optional().nullable(),
  payment_per_day: z.number({ required_error: "Kunlik ish haqini kiriting!" }).optional().nullable(),
  payment_per_product: z.number({ required_error: "Mahsulot haqini kiriting!" }).optional().nullable(),
  payment_per_month: z.number({ required_error: "Oylik ish haqini kiriting!" }).optional().nullable(),

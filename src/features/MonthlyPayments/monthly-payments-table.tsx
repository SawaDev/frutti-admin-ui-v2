...
import { GetMonthlyPaymentsResponse } from "./monthlyPayment.type";
import useMonthlyPayments from "./useMonthlyPayments";

interface MonthlyPaymentsTableType {
  data: GetMonthlyPaymentsResponse | undefined;
}

const CollapsedRows: React.FC<{
  data: GetMonthlyPaymentsResponse["data"][0]["payments"][0];
}> = ({ data }) => {
  return (
